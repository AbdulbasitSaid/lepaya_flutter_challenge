...
void main() {
  ...
  testWidgets(
    "Hot litsting should be scrolled and clicking on a hot list card should open the url of the post",
    (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle();
//find and tap the tab
      final hotListingTab = find.byKey(const ValueKey('hot-tab'));
      await tester.tap(hotListingTab);
      await tester.pumpAndSettle();
      // find and tap scroll the listview
      final hotListingScroll = find.byKey(const ValueKey('hot-listview'));
      await tester.pumpAndSettle();
